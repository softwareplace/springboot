...
buildscript {
    ...
    System.setProperty("passayVersion", "1.6.3")
    ...
    System.setProperty("springBootSecurityUtilVersion", "1.0.0-SNAPSHOT")
    ...
    System.setProperty("mapStruct", "1.5.5.Final")
    System.setProperty("slf4jApiVersion", "2.0.7")
}
